...
public interface ErrorCode {
    ...
    // 移动端账户域
    int ACCOUNT_STATE_INVALID = 10210;
    int ACCOUNT_DELETION_PENDING = 10211;
    int VERIFICATION_TICKET_INVALID = 10212;
    int VERIFICATION_SCENE_INVALID = 10213;
    int COMBINATION_INVALID = 10214;
    int COMBINATION_NOT_SET = 10215;
    int GUARDIAN_PIN_INVALID = 10216;
    int GUARDIAN_PIN_LOCKED = 10217;
    int PHONE_CHANGE_INVALID = 10218;
    int DEVICE_ALREADY_BOUND_ACCOUNT = 10219;
    int MEDIA_ASSET_INVALID = 10220;
    int ACCOUNT_RESOURCE_NO_PERMISSION = 10221;
    int DELETION_REQUEST_INVALID = 10222;
    int HARDWARE_NOT_OURS = 10223;
    int HARDWARE_REVOKED = 10224;
    int HARDWARE_ALREADY_ACTIVATED = 10225;
    int HARDWARE_ACTIVATION_INVALID = 10226;
    int HARDWARE_UNBIND_INVALID = 10227;
    int HARDWARE_REQUEST_DUPLICATE = 10228;
}
