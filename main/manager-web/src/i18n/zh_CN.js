export default {
  ...
  'roleConfig.additionalPrompt': '个性特色',
  'roleConfig.additionalPromptPlaceholder': '请输入需要在每次大模型请求中附加的个性化指令',
  ...
  'roleConfig.tooltip.additionalPrompt': '作为独立附加指令动态注入系统提示词，并随每次大模型请求发送',
