export default {
  ...
  'roleConfig.additionalPrompt': '附加提示詞',
  'roleConfig.additionalPromptPlaceholder': '請輸入需要在每次大模型請求中附加的個性化指令',
  ...
  'roleConfig.tooltip.additionalPrompt': '作為獨立附加指令動態注入系統提示詞，並隨每次大模型請求發送',
